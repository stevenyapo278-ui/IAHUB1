import { Flame, AlertTriangle, Info, ArrowDown, Sparkles, Radio, Clock, CheckCircle2 } from 'lucide-react';

export const STATUS_OPTIONS = ['NEW', 'OPEN', 'PENDING', 'SOLVED', 'CLOSED'];
...
export const STATUS_CONFIG = {
  ...
  OPEN: { label: 'En cours', bg: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/25 font-bold', Icon: Radio },
