...
import {
  ...
  Lock, Mail, Eye, EyeOff, AlertTriangle, Sparkles,
} from 'lucide-react';

/* ── Design historique de la page de connexion (conservé dans la rotation) ── */

const containerVariants = { hidden: { opacity: 1 }, visible: { opacity: 1 } };
const itemVariants = { hidden: { opacity: 1 }, visible: { opacity: 1 } };
const cardVariants = { hidden: { opacity: 1 }, visible: { opacity: 1 } };
